    ...
    <div className="styleRoutes">
      <div className="card headCardReport resultBorderRadius  mx-auto noBorder"> 
            <div className="ml-3 text-white row mx-auto">
                <h3 className="mb-0 mt-2  font-weight-bold">Routes</h3>
                </div>
        </div>
